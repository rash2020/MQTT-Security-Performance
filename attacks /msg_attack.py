...
HOST = ".........."  # The same broker as before
...
def flood_mqtt(client_id):
    ...
    # Simulate a TLS connection without certificates or proper authentication (no valid token or keys)
    client.tls_set(certfile=None, keyfile=None, ca_certs=None, tls_version=ssl.PROTOCOL_TLSv1_2)
    
    try:
        # Attempt to connect to the MQTT broker without proper authentication
        ...
        while True:
            ...
            # Publish to the topic, but without valid credentials (this should fail)
